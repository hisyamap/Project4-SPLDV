...
echo '                                    <a class="btn btn-primary me-2" href="#" aria-current="page">Home</a>';
echo '                                </li>';
echo '                                <li class="nav-item">';
echo '                                    <a class="btn btn-primary" href="#">Apersepsi</a>';
echo '                                </li>';
echo '                                <a class="navbar-brand" href="#"><h1 class="website-name">SPLDV</h1></a>';
echo '                            </ul>';
...
echo '                                    <a class="btn btn-primary " href="#" aria-current="page">Contoh Soal</a>';
echo '                                </li>';
echo '                            </ul>';
echo '                        </div>';
echo '                    </div>';
...
echo '                        </div>';
echo '                    </div>';
echo '                    <div class="pt-3 pb-3 d-flex justify-content-evenly">';
...
echo '                                        <a href="https://phet.colorado.edu/in/simulations/equality-explorer-two-variables" class="stretched-link">Equality Explorer: Two Variables</a>';
echo '                                    </div>';
echo '                                </div>';
echo '                            </div>';
...
echo '                                    </div>';
echo '                                    <div class="card-body col-md-4 blog-title">';
echo '                                        <a href="https://www.geogebra.org/graphing?lang=en" class="stretched-link">Graphing Calculator</a>';
echo '                                    </div>';
echo '                                </div>';
echo '                            </div>';
echo '                        </div>';
...
echo '                                    </div>';
echo '                                    <div class="card-body col-md-4 blog-title">';
echo '                                        <a href="https://mathigon.org/task/simultaneous-equations" class="stretched-link">Simultaneous Equations</a>';
echo '                                    </div>';
echo '                                </div>';
echo '                            </div>';
echo '                            <div class="card">';
...
echo '                                    </div>';
echo '                                    <div class="card-body col-md-4 blog-title">';
echo '                                        <a href=" https://www.wolframalpha.com/examples/mathematics/algebra/equation-solving" class="stretched-link">Equation Solving</a>';
echo '                                    </div>';
echo '                                </div>';
echo '                            </div>';
echo '                        </div>';
